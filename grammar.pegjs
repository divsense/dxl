...
// ==================
//
// Generated parser builds Divsense Nodes
//
...
Start = __ node:Node __ { return node; }

Node 
    = e:Expression __ branch:(Branch __)? {
...
Head 
    = bool:BooleanLiteral { return booleanNode(bool) }
    / id:Identifier { return "divsense:" + id }
    / ext:Identifier ":" id:Identifier { return ext + ":" + id }
    / txt:StringLiteral { return textNode(txt) }
    / num:NumericLiteral { return numberNode(num) }

Feature
    = "." path:Path __ "(" __ param:Parameter __ ")" {
        return R.set(R.lensPath(path), param, {})
    }
    / "." path:Path __ "[" __ params:(ParameterList __) "]" {
        return R.set(R.lensPath(path), params, {})
    }

Path
    = id:Identifier seg:(__ PathSegment)* {
        return buildList(id, seg, 1);
    }

PathSegment
    = "/" __ id:Identifier { return id }
...
Parameter
    = StringLiteral / BooleanLiteral / NumericLiteral / NullLiteral
...
Identifier
  = !BooleanLiteral name:IdentifierName { return name; }
